 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_npci_cryptocore_KEMs_max_1number_1KEMs
 ...
 */
JNIEXPORT jboolean JNICALL Java_npci_cryptocore_KEMs_is_1KEM_1enabled
 ...
 */
JNIEXPORT jstring JNICALL Java_npci_cryptocore_KEMs_get_1KEM_1name
